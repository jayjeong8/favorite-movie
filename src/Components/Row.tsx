...
import {
    ClickedMovie, ClickedTV, FavoriteMovie, FavoriteTV, IncreaseState, ModalLeaving,
    MovieNowPlaying,
    MoviePopular,
    MovieTopRated,
    MovieUpcoming,
                                    ...
                                    .map((content) => (
                                        <BoxContainer key={content.id}>
                                            ...
                                            <InfoContainer>
                                                ...
                                                {queryKeyName1 === "MOVIE" ?
                                                    <Star content={content} color={favoriteMovie.find(movie => movie.id === content.id) ? COLOR_YELLOW : COLOR_BLACK} checkMedia={queryKeyName1}/>
                                                    : <Star content={content} color={favoriteTV.find(tv => tv.id === content.id) ? COLOR_YELLOW : COLOR_BLACK} checkMedia={queryKeyName1}/>}
                                            </InfoContainer>
                                        </BoxContainer>
                                    ))}
                            </InRow>
