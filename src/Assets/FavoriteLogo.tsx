...
export default function FavoriteLogo() {
    return (
        <Svg
            ...
            <motion.path d="M110.024 28.323H119.058C122.069 28.323 128.092 30.1298 128.092 37.3571" stroke={strokeColor}
                         strokeWidth={strokeWidth} strokeLinecap="round"/>
            <motion.path d="M132.609 10.2546H123.575" stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round"/>
            <motion.path
            ...
            <motion.path
                ...
                stroke={strokeColor} strokeWidth={strokeWidth} strokeLinecap="round"/>
            <motion.circle cx="10.6484" cy="10.2547" r="9.03413" stroke={strokeColor} strokeWidth={strokeWidth}
                           strokeLinecap="round"/>
            <motion.path
