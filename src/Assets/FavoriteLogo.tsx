...
export default function FavoriteLogo() {
    return (
        <Svg
            ...
            animate="normal"
            whileHover="active"
            width="current" height="current" viewBox="0 0 134 39" fill="none" xmlns="http://www.w3.org/2000/svg">
            <motion.path d="M110.024 28.323H119.058C122.069 28.323 128.092 30.1298 128.092 37.3571" stroke="#D3D3C5"
                         stroke-width={strokeWidth} stroke-linecap="round"/>
            <motion.path d="M132.609 10.2546H123.575" stroke="#D3D3C5" stroke-width={strokeWidth} stroke-linecap="round"/>
            <motion.path
                d="M114.541 1C117.552 1 123.575 2.80683 123.575 10.0341C123.575 17.2614 123.575 16.8097 123.575 19.0683"
                stroke="#D3D3C5" stroke-width={strokeWidth} stroke-linecap="round"/>
            <motion.path
                ...
                stroke="#D3D3C5" stroke-width={strokeWidth} stroke-linecap="round"/>
            <motion.circle cx="10.6484" cy="10.2547" r="9.03413" stroke="#D3D3C5" stroke-width={strokeWidth}
            ...
            <motion.path
                ...
                stroke="#D3D3C5" stroke-width={strokeWidth} stroke-linecap="round"/>
            <motion.circle cx="73.8873" cy="28.3229" r="9.03413" stroke="#D3D3C5" stroke-width={strokeWidth}
                           stroke-linecap="round"/>
        </Svg>
    )
}
