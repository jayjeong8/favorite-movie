...
function FavoriteLogo() {
    return (
        <Svg
            ...
            <motion.path d="M132.609 10.2546H123.575" stroke="#D3D3C5" stroke-width="2" stroke-linecap="round"/>
            <motion.path
                d="M114.541 1C117.552 1 123.575 2.80683 123.575 10.0341C123.575 17.2614 123.575 16.8097 123.575 19.0683"
                stroke="#D3D3C5" stroke-width="2" stroke-linecap="round"/>
            <motion.path
                ...
                stroke="#D3D3C5" stroke-width="2" stroke-linecap="round"/>
            <motion.circle cx="10.6484" cy="10.2547" r="9.03413" stroke="#D3D3C5" stroke-width="2"
            ...
            <motion.path
                ...
                stroke="#D3D3C5" stroke-width="2" stroke-linecap="round"/>
            <motion.circle cx="73.8873" cy="28.3229" r="9.03413" stroke="#D3D3C5" stroke-width="2"
                           stroke-linecap="round"/>
        </Svg>
    )
}
